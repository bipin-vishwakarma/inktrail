...
const SLIDES = [
    {
        ...
        description: 'Type "Q1.", "Ans:", "(a)", or "(i)" anywhere in your text. InkTrail automatically isolates the question index and stamps it into the authentic left red rule — just like real Indian student notebooks.',
        demo: (
    ...
    },
    {
        ...
        description: 'Engineering and science practical records require blank/plain facing sheets for circuit schematics, ray diagrams, or graphs, paired with ruled sheets for written observations. InkTrail handles alternating pages and diagram uploads seamlessly!',
        demo: (
    ...
    },
    {
        ...
        description: 'InkTrail goes far beyond simple fonts: it simulates human hand fatigue (writing gets slightly looser down the page), realistic ballpoint jitter, wavy pen strikethroughs, desk lamp warmth, and 3D smartphone cast shadows.',
        demo: (
