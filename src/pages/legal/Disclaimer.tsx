...
export default function Disclaimer() {
    return (
        <PageLayout 
            ...
            subtitle="Understanding the educational purpose, realistic simulation, and ethical use of InkTrail."
        >
            ...
            <p>
                InkTrail is engineered specifically to help university and school students format, preview, and print study material, homework drafts, and laboratory practical notebooks (interleaved diagram and ruled observation sheets). It reduces repetitive strain injury (RSI) while providing high-quality digital layout for assignments.
            </p>

            <h3>3. Academic Integrity & Responsible Use</h3>
            <p>
                We firmly advocate for academic honesty and ethical learning practices. InkTrail is intended as an assistive study and formatting utility. It should never be employed for academic fraud, examination deception, impersonation, or submitting unoriginal work where individual handwritten production is strictly monitored and required under honor codes. Students remain exclusively responsible for ensuring compliance with their respective academic institution's code of conduct.
            </p>
            ...
            <p>
                All text rendering, AI cleaning, and PDF exports are processed client-side within your browser. InkTrail does not sell, harvest, or transmit your assignments or document content to external servers.
            </p>
